...
const classes = computed(() => {
  ...
  if (props.inverse) {
     ...
     switch (props.color) {
        case 'primary': c.push('text-primary'); break;
        case 'muted': c.push('text-theme-text'); break; // Match $text-color
        case 'white': c.push('text-white'); break;
        default: c.push('text-theme-heading'); // Match h1-h6 color #4f4f4f
     }
  }
  ...
  // h3: 24px
  switch (props.level) {
    case 1: c.push('text-[36px] font-medium leading-tight mb-[10px]'); break;
    case 2: c.push('text-[30px] font-medium leading-tight mb-[10px]'); break;
    case 3: c.push('text-[24px] font-medium leading-snug mb-[10px]'); break;
    case 4: c.push('text-[20px] font-medium leading-snug mb-[10px]'); break;
    case 5: c.push('text-[17px] font-medium leading-normal mb-[10px]'); break;
    default: c.push('text-[15px] font-medium leading-normal mb-[10px]');
  }
  ...
  if (props.variant === 'subtitle') {
       c.push('border-l-[3px] border-primary pl-[15px] uppercase font-bold mb-[20px] text-theme-heading');

    ...
    <header id="header" class="bg-background/80 backdrop-blur-md relative z-50 h-20 border-b border-border">
        ...
        <div v-show="isOpen"
            ...
            <nav class="flex flex-col p-4 gap-4">
                <a href="/features"
                    class="block px-4 py-2 text-gray-300 hover:text-white hover:bg-white/5 rounded-md">Fonctionnalités</a>
                <a href="/docs"
                    class="block px-4 py-2 text-gray-300 hover:text-white hover:bg-white/5 rounded-md">Documentation</a>
                <a href="/pricing"
                    class="block px-4 py-2 text-gray-300 hover:text-white hover:bg-white/5 rounded-md">Tarifs</a>

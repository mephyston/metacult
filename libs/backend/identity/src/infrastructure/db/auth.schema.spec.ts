...
describe('Identity Schemas (Drizzle)', () => {
  describe('User Schema', () => {
    it('should have correct table name with identity schema prefix', () => {
      ...
      expect(
        (user as unknown as Record<string | symbol, unknown>)[
    ...
    it('should have required fields defined', () => {
      const columns = (user as unknown as Record<string | symbol, any>)[
  ...
  describe('Verification Schema', () => {
    it('should have correct table name', () => {
      ...
      expect((verification as any)[Symbol.for('drizzle:Name')]).toBe(
        'verification',
      );
    });

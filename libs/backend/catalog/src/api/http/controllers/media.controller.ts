...
import type { MediaDetailDto } from '../../../application/dtos/media-detail.dto';
import type { MediaReadDto } from '../../../application/dtos/media-read.dto'; // Assuming it might be used or needed explicitly

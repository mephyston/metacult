...
const mockOrderBy = mock(() => ({ where: mockWhere, limit: mockLimit, execute: mockExecute }));
...
// Tags Subquery Mocks
const mockExecuteTags = mock(() => Promise.resolve([
    { mediaId: '1', tagSlug: 'fps', tagLabel: 'FPS' }
]));
const mockWhereTags = mock(() => Promise.resolve([{ mediaId: '1', tagSlug: 'fps', tagLabel: 'FPS' }])); // execute is implied if awaitable? Drizzle awaits promise-like.
